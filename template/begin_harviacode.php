...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" language="javascript" src="https://<?=$_SERVER['HTTP_HOST']?>/JavaScript/fwJS.js"></script>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                     <?= utf8_encode('Olá, '). $_SESSION['pessoa_nm']?>
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="#"><i class=""></i> <?=utf8_encode('Lotação: ').$_SESSION['est_organizacional_lotacao_sigla']?></a></li>
                    <li><a href="../Intranet/usuario"><i class="fa fa-sign-out pull-right"></i> Sair</a></li>
                  </ul>
                </li>
