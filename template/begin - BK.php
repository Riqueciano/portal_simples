                ...
                $.ajax({
                    ...
                    success: function (retorno) {
                        ...
                        if (retorno == 'session_vazia') {
                            alert('Sessï¿½o encerrada por falta de uso, favor efetuar o login novamente');
                                ...
                                <ul class="nav navbar-nav navbar-right" >
                                    ...
                                    <li class="">
                                        ...
                                        <ul class="dropdown-menu dropdown-usermenu pull-right" style='width:65%'>
                                            ...
                                            <li><a href="#"><i class=""></i>Modulo: <?= @nomeSistema($sistema_id) ?></a></li>
                                            <li><a href="#"><i class=""></i>Perfil: <?= $_SESSION['Sistemas'][$_SESSION['sistema']] ?></a></li>
                                            <li><a href="#"><i class=""></i> <?= 'Lotaçao:'. $_SESSION['est_organizacional_lotacao_sigla'] ?></a></li>
