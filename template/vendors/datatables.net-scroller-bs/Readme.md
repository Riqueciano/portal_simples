# Scroller for DataTables with styling for [Bootstrap](https://getbootstrap.com/)

This package contains distribution files required to style [Scroller extension](https://datatables.net/extensions/scroller) for [DataTables](https://datatables.net/) with styling for [Bootstrap](https://getbootstrap.com/).
