...
[![NPM version](https://badge.fury.io/js/datejs.svg)](https://badge.fury.io/js/datejs)
...
#### For a Browser 
If you use [Bower](https://bower.io/) to manage your frontend packages then it's also really simple:
...
* `specs` Unit Tests written using [Jasmine](https://pivotal.github.io/jasmine/). Code coverage is calculated by [BlanketJS](https://blanketjs.org/). 
