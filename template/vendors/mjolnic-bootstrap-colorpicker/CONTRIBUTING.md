...
that the fine folks at [StackOverflow](https://stackoverflow.com/) will be able to help you; simply describe the problem
...
- Try to reproduce your problem in a separated environment, like in JSFiddle,
  [here is a template for it](https://jsfiddle.net/mjolnic/0vopxm13/), that you can fork in the same page.
...
- For checking your changes in the browser you can execute `node serve` and navigate to https://127.0.0.1:5000/
