...
- Install with [NPM](https://npmjs.org): `npm install cropper`.
...
> Requires [CSS3 2D Transforms](https://caniuse.com/transforms2d) support (IE 9+).
...
- Browser support:
  - Basic image: requires [Canvas](https://caniuse.com/canvas) support (IE 9+).
  - Rotated image: requires [CSS3 2D Transforms](https://caniuse.com/transforms2d) support (IE 9+).
...
[MIT](https://opensource.org/licenses/MIT) © [Fengyuan Chen](https://chenfengyuan.com)
