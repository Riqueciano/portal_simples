...
![Version](https://img.shields.io/version/2.1.6.png?color=green)
...
## Features
[![](https://github.com/rendro/easy-pie-chart/raw/master/demo/img/easy-pie-chart.png)](https://drbl.in/ezuc)
...
<table>
    ...
    <tr>
        ...
        <td>defaultEasing</td>
        <td>Easing function or string with the name of a <a href="https://gsgd.co.uk/sandbox/jquery/easing/" target="_blank">jQuery easing function</a></td>
    </tr>
</table>
...
When using [RequireJS](https://requirejs.org) you can define your own name. Examples can be found in the `demo/requirejs.html`.
