...
to use [vbscript](https://stackoverflow.com/questions/1095102/how-do-i-load-binary-image-data-using-javascript-and-xmlhttprequest)
and non standard attributes.
On IE > 9, overrideMimeType doesn't work but xhr2 does.

With [xhr 2](https://caniuse.com/xhr2), you can just set the responseType
attribute : `xhr.responseType = "arraybuffer";`. With this, the browser will
return an ArrayBuffer.

#### Local files

If the browser supports the [FileReader API](https://caniuse.com/filereader),
...
[http](https://nodejs.org/docs/latest/api/http.html) to the
...
var req = http.get(url.parse("https://127.0.0.1/.../file.zip"), function (res) {
