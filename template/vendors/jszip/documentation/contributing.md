...
JSZip uses Grunt to handle the build, [see here to install its CLI](https://gruntjs.com/getting-started).
...
need to [install jekyll](https://jekyllrb.com/docs/installation/) and then run
