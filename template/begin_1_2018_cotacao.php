...
<head>
    ...
    <!-- ##### full calendar -->
    <link href='https://<?= $_SERVER['HTTP_HOST'] . '/' . $nmServer ?>/JavaScript/fullcalendar/lib/main.css' rel='stylesheet' />
    <script src='https://<?= $_SERVER['HTTP_HOST'] . '/' . $nmServer ?>/JavaScript/fullcalendar/lib/main.js'></script>
    <!-- ##### full calendar -->
                ...
                <div class="left_col scroll-view">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><br>
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                               ...
                               from seguranca.tipo_usuario tu
                                    ...
                                    where s.secao_st = 0 and s.sistema_id = " . (int) $sistema_id . " and utu.pessoa_id = 99999999 
					    ...
					    on s.sistema_id = tu.sistema_id        
                                    where a.acao_st = 0 and a.secao_id =" . $s->secao_id . " and s.sistema_id = " . (int) $sistema_id . " and utu.pessoa_id = 9999999
