...
if (empty($_SESSION['solicitacao_id'])) {
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><br>
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] .'/'.$nmServer?>/Selo/solicitacao/create"><i class="glyphicon glyphicon-user"></i> Faça seu cadastro </a>
                                    </li> 
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] .'/'.$nmServer?>/Selo/login"><i class="glyphicon glyphicon-globe"></i> Login  </a>
                                    </li> 
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] ?>/selo/login/inicio_Login_esqueceu"><i class="glyphicon glyphicon-search"></i> Esqueci a senha  </a>
                                    </li>
