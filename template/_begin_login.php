...
error_reporting(E_ALL & ~E_DEPRECATED & ~E_NOTICE);
    ...
    <html lang="en">
        <head>
            ...
            <script src="https://<?= $_SERVER['HTTP_HOST'] ?>/template/production/js/jquery.min.js"></script>
                        ...
                        <div class="left_col scroll-view">
                            ...
                            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><br>
                                <div class="menu_section">
                                    <h3 style="cursor:pointer" onclick='window.open("https://<?php echo $_SERVER['HTTP_HOST'] . '/' . $nmServer; ?>/Intranet/publicacao", "_self")'><i class="fa fa-home"></i>INTRANET</h3><br>
                                    <!--ul class="nav side-menu">    
                                            <li><a><i class="<?= rupper(32132132) ?>"></i> 432234243 <span class="fa fa-chevron-down"></span></a>
                                                <ul class="nav child_menu">                                                   
                                                     <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] . '/' . 321123 . '/' . 23123 . '/' . 234432 ?>"><?= ((432342)) ?></a></li>        
                                                </ul>
                                            </li> 
