...
//echo '<pre>'; print_r($_SESSION['Sistemas'][$_SESSION['sistema']]); echo '</pre>';
    ...
    <html lang="en">
        <head>
            ...
            <script src="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/js/bootstrap_2.min.js"></script>



            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/bootstrap.min.css" rel="stylesheet">

            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/fonts/css/font-awesome.min.css" rel="stylesheet">
            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/animate.min.css" rel="stylesheet">

            <!-- Custom styling plus plugins -->
            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/custom.css" rel="stylesheet">
            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/icheck/flat/green.css" rel="stylesheet">


            <script src="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/js/jquery.min.js"></script>

            <script type="text/javascript" src="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/js/wizard/jquery.smartWizard.js"></script>
            <!-- Bootstrap core CSS -->
            ...
            <!-- editor -->
            <!--link href="https://netdna.bootstrapcdn.com/font-awesome/3.0.2/css/font-awesome.css" rel="stylesheet"-->
            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/font-awesome.css" rel="stylesheet">


            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/editor/external/google-code-prettify/prettify.css" rel="stylesheet">
            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/editor/index.css" rel="stylesheet">
            <!-- select2 -->
            <link href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/select/select2.min.css" rel="stylesheet">
            <!-- switchery -->
            <link rel="stylesheet" href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/switchery/switchery.min.css" />
            
            <!--
            <script type="text/javascript" language="javascript" src="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/js/jexcel-master/dist/jexcel.js"></script>
            <link rel="stylesheet" href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/js/jexcel-master/dist/jexcel.css" />
            -->
             <link rel="stylesheet" href="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/production/css/switchery/switchery.min.css" />
            <script type="text/javascript" language="javascript" src="https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/JavaScript/fwJS.js"></script>
            <!--
  ...
  font-style: normal;
        ...
        <script>
            ...
            function AjaxverificaSession() {
                $.ajax({
                    url: "https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/template/verifica_session/verifica_session.php",
                    type: "POST",
                    dataType: "html",
                    async: false,
                    data: {
                    ...
                    success: function (retorno) {
                        ...
                        if (retorno == 'session_vazia') {
                            ...
                            window.open('https://<?= $_SERVER['HTTP_HOST'] ?>/_portal', '_self');
                        }
                    }
                });
            }
            ...
            function abreTransicao(pagina) {            
                $('#form_begin').attr("action",'https://<?= $_SERVER['HTTP_HOST'] ?>/_portal/Login/transicao');
                                ...
                                <ul class="nav navbar-nav navbar-right" >
                                    ...
                                    <li class="">
                                        ...
                                        <ul class="dropdown-menu dropdown-usermenu pull-right" style='width:65%'>
                                            ...
                                            <li><a href="#"><i class=""></i>Lotação: <?= $_SESSION['UsuarioEstDescricao'] ?></a></li>
                                            ...
                                            <li><a href="https://<?php echo $_SERVER['HTTP_HOST'] ?>/_portal/Home/Login.php?acao=LogOff"><i class="fa fa-sign-out pull-right"></i> Sair</a></li>
                                        </ul>
                                    </li>
