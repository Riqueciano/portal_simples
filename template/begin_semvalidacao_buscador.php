                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><br>
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] ?>/_portal/AcervoDigital/Usuario/create"><i class="glyphicon glyphicon-user"></i> Faça seu cadastro </a>
                                    </li> 
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] ?>/intranetsdr/?model_ini=model_login_buscador&pag=login_buscador"><i class="glyphicon glyphicon-globe"></i> Espaço do Autor  </a>
                                    </li> 
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] ?>/_portal/AcervoDigital/obra/obra_buscador/"><i class="glyphicon glyphicon-search"></i> Faça sua pesquisa  </a>
                                    </li> 
