                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><br>
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] .'/'.$nmServer?>/Semente_crioula/inscricao/create"><i class="glyphicon glyphicon-th-large"></i> Cadastre sua Experiência</a>
                                    </li> 
                                    <?php if(!empty($_SESSION['pessoa_id'])) { ?>
                                    <li>  
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] .'/'.$nmServer?>/Semente_crioula/inscricao/buscador/"><i class="glyphicon glyphicon-search"></i> Faça sua pesquisa  </a>
                                    </li>
                                    <?php } ?>
                                    <li>
                                        <a href="https://<?=$_SERVER['HTTP_HOST'] .'/'.$nmServer?>/Semente_crioula/inscricao/dados/"><i class="glyphicon glyphicon-th-large"></i> Dados  </a>
                                    </li> 
