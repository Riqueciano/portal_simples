...
class Tipo_usuario_acao extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $tipo_usuario_id = intval($this->input->get('tipo_usuario_id'));
        ...
        if (!empty($tipo_usuario_id)) {
            $param .= " and tipo_usuario.tipo_usuario_id = " . $tipo_usuario_id;
            $tem_filtro = 1;
        }
        //se não tiver filtros aplicados, a consulta vem vazia
        if ($tem_filtro == 0) {
            $param = " and 1=2";
        }
        // echo $param;
