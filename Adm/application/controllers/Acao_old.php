...
<body><?php //echo $action; 
        ?>
    <h2 style="margin-top:0px"><span id='spanAcaoForm'><i class='glyphicon glyphicon-chevron-right'></i>Cadastro</span> sub-Menu (ação) <?php // echo $button  ?></h2>
                    ...
                    <div style='overflow-x:auto'>
                        ...
                        <table class='table'>
                            <tr>
                                ...
                                <td>
                                    <div class="item form-group">
                                        <?php echo comboSimples('sistema_id_temp', 'seguranca.sistema', 'sistema_id', 'sistema_nm', 'ajax_busca_secao_pelo_sistema()', $sistema_id_temp, " order by sistema_nm"); ?>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <label for="smallint">Seção(menu)* <?php echo form_error('secao_id') ?></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="item form-group">
                                        <?php //echo combo('secao_id', 'seguranca.secao', 'secao_id', 'secao_ds', '', $secao_id, " order by secao_ds"); 
                                        ?>
                            ...
                            <tr>
                                ...
                                <td>  
                                    <div class="form-group">
                                        <label for="character varying">Descrição* <?php echo form_error('acao_ds') ?></label>
                                    </div>
                                </td>  
                                <td>
                                    <div class="item form-group">
