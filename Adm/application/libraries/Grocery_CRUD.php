 ...
 * @author     	John Skoumbourdis <scoumbourdisj@gmail.com>
 * @license     https://github.com/scoumbourdis/grocery-crud/blob/master/license-grocery-crud.txt
 * @link		https://www.grocerycrud.com/documentation
 */
...
class Grocery_CRUD extends grocery_CRUD_States
{
	 ...
	 * For example:
	 * Let's say we have the path https://www.example.com/ however the original url path is
	 * https://www.example.com/example/index . We have to specify the url so we can have
	...
	public function add_action( $label, $image_url = '', $link_url = '', $css_class = '', $url_callback = null)
	{
		...
		$this->actions[$unique_id]  = (object)array(
			...
			'url_has_http'	=> substr($link_url,0,7) == 'https://' || substr($link_url,0,8) == 'https://' ? true : false
		);
