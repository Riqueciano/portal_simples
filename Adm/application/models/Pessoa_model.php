...
class Pessoa_model extends CI_Model
{
    ...
    function total_rows($q = NULL)
    {
        ...
        // $this->db->or_ilike('pessoa.lotacao_id', $q);
        // $this->db->or_ilike('pessoa.ddd_telefone', $q);
        // $this->db->or_ilike('pessoa.telefone', $q);
        // $this->db->or_ilike('pessoa.ddd_celular', $q);
        // $this->db->or_ilike('pessoa.celular', $q);
        $this->db->join('dados_unico.lotacao', 'pessoa.lotacao_id = lotacao.lotacao_id', 'INNER');
        $this->db->join('dados_unico.empresa', 'pessoa.empresa_id = empresa.empresa_id', 'INNER');
    ...
    function get_all_data($param, $order = null)
    {
        ...
        $this->db->join('dados_unico.lotacao as l2', 'pessoa.lotacao_id = l2.lotacao_id', 'INNER');
        $this->db->join('dados_unico.empresa', 'pessoa.empresa_id = empresa.empresa_id', 'INNER');
        $this->db->where($where);
