(function(){
    ...
    var options = {
        ...
        onShow: function(){
                        $('#pleaserotate-graphic').css('width','100%');
                        $('#pleaserotate-message').css('font-size','30px');
                    },
        forcePortrait: false,
        message: "Por favor, mudar a orientação para horizontal",
        subMessage: "",
        allowClickBypass: false,//click
        onlyMobile: true,
        zIndex: 1000,
        iconNode: null
    };
    ...
    var cssRules = [
       "#pleaserotate-graphic { margin-left: 10px; width: 100px; animation: pleaserotateframes ease 2s; animation-iteration-count: infinite; transform-origin: 50% 50%; -webkit-animation: pleaserotateframes ease 2s; -webkit-animation-iteration-count: infinite; -webkit-transform-origin: 50% 50%; -moz-animation: pleaserotateframes ease 2s; -moz-animation-iteration-count: infinite; -moz-transform-origin: 50% 50%; -ms-animation: pleaserotateframes ease 2s; -ms-animation-iteration-count: infinite; -ms-transform-origin: 50% 50%; }",
