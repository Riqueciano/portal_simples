...
class Harviacode
{
    ...
    function connection()
    {
        ...
        $this->sql =  pg_connect("host=127.0.0.1 dbname=bd_gestor_sdr port=5433 user=postgres password=SUA_SENHA");
    ...
    function primary_field($table)
    {
       ...
       // echo $table;exit;
        ...
        $query = "SELECT COLUMN_NAME as column_name, case when dtd_identifier =1 then 'ON' 
    ...
    function not_primary_field($table)
    {
        ...
        $query = "SELECT COLUMN_NAME,case when dtd_identifier =1 then 'ON' 
                                           else 'NO' end as COLUMN_KEY,DATA_TYPE 
                        ,character_maximum_length,is_nullable     
