...
class Pessoa_model extends CI_Model
{
	...
	$this->db->or_ilike('pessoa.ater_contrato_id', $q);
	$this->db->or_ilike('pessoa.lote_id', $q);
	$this->db->join('diaria_old.setaf','pessoa.setaf_id = setaf.setaf_id', 'INNER');
	$this->db->join('sigater_indireta.lote','pessoa.lote_id = lote.lote_id', 'INNER');
