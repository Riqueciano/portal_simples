...
[![Bower version](https://badge.fury.io/bo/bootstrap-fileinput.svg)](https://badge.fury.io/bo/bootstrap-fileinput)
...
View the [plugin documentation](https://plugins.krajee.com/file-input) and [plugin demos](https://plugins.krajee.com/file-input/demo) at Krajee JQuery plugins. 

## Pre-requisites  

1. [Bootstrap 3.x](https://getbootstrap.com/)
2. Latest [JQuery](https://jquery.com/)
