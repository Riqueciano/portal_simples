 ...
 *  (c) 2014 Julio De La Calle - https://dixso.net - @dixso9
 *
...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        _hexToRgb: function ( hex ) {
            // Expand shorthand form (e.g. "03F") to full form (e.g. "0033FF") - https://stackoverflow.com/questions/5623838/rgb-to-hex-and-hex-to-rgb
