...
for (i = 0; i < no; ++ i){
  ...
  if (ie4up||ns6up){
      if (i == 0){
        document.write("<a href=\"https://www.darcweb.com.br\" target=\"_blank\"><div id=\"dot"+ i +"\" style=\"position: absolute; z-index: "+ i +"; visibility: visible; top: 0px; left: 15px;\"><img src='"+snowsrc+"' border=\"0\"><\/div><\/a>");
      }else{
