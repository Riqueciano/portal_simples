...
class Pessoa_fisica extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('pessoa_fisica/Pessoa_fisica_list', forFrontVue($data));
	}
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			$this->load->view('pessoa_fisica/Pessoa_fisica_form', forFrontVue($data));
		} else {
	...
	public function report()
	{
		...
		$this->load->view('pessoa_fisica/Pessoa_fisica_report', forFrontVue($data));
	}
}

/* End of file Pessoa_fisica.php */
/* Local: ./application/controllers/Pessoa_fisica.php */
/* Gerado por RGenerator - 2024-01-24 18:46:12 */