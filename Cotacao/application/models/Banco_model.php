...
class Banco_model extends CI_Model {
    ...
    public $table = 'dados_unico.banco';
    public $id = 'banco_id';
    public $order = 'DESC';
    ...
    function get_limit_data($limit, $start = 0, $q = NULL) {
        ...
        $this->db->or_ilike('banco.banco_cd', $q);
        $this->db->or_ilike('banco.banco_ds', $q);  
...
/* Final do arquivo Banco_model.php */
/* Local: ./application/models/Banco_model.php */
/* Data - 2020-01-16 20:12:53 */