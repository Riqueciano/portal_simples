...
class Novo_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        ...
        $this->db->ilike('cotacao.novo.novo_id', $q);
	$this->db->or_ilike('novo.novo', $q);
	$this->db->or_ilike('novo.dataa', $q);
...
/* Final do arquivo Novo_model.php */
/* Local: ./application/models/Novo_model.php */
/* Data - 2024-01-19 14:31:29 */