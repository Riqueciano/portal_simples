...
class Teste_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        ...
        $this->db->ilike('cotacao.teste.teste_id', $q);
	$this->db->or_ilike('teste.teste_nm', $q);
    ...
    function get_limit_data($limit, $start = 0, $q = NULL) {
        $this->db->select('*');
        $this->db->order_by($this->table.'.'.$this->id, $this->order);
        $this->db->ilike('teste.teste_id', $q);
	$this->db->or_ilike('teste.teste_nm', $q);
...
/* Final do arquivo Teste_model.php */
/* Local: ./application/models/Teste_model.php */
/* Data - 2024-01-17 19:31:41 */