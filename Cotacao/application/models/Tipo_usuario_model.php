...
function get_pessoa_perfil($tipo_usuario_id){
    $sql = "
                select 
                        ...
                        , usuario_login
                        , telefone from vi_login vl
                    inner join vi_pessoa vp 
                        on vp.pessoa_id = vl.pessoa_id
                where vl.tipo_usuario_id = $tipo_usuario_id 

                    order by unidade_orcamentaria_id asc, vl.pessoa_nm asc
    ";
    ...
    function get_limit_data($limit, $start = 0, $q = NULL, $filtro_sistema_id)
    {
