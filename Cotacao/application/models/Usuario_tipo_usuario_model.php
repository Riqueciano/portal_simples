...
class Usuario_tipo_usuario_model extends CI_Model
{
    ...
    function tem_esse_perfil($pessoa_id){
        $sql = "select 1 from seguranca.usuario_tipo_usuario where pessoa_id = $pessoa_id and tipo_usuario_id = 442 /*fornecedor*/";
   ...
   /*function delete($id)
    ...
    function delete_por_pessoa($pessoa_id){
