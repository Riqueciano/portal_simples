            ...
            <table class="table table-striped" style="margin-bottom: 10px">
                <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo utf8_encode(rupper($acao->sistema_nm)) ?></td>
                        <td><?php echo utf8_encode($acao->secao_ds) ?></td>
                        <td><?php echo utf8_encode($acao->acao_ds) ?></td>
                        <td><?php echo utf8_encode($acao->acao_url) ?></td>
                        <td>
