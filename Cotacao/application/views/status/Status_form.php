...
<html>
    ...
    <div>    
      <h2 style="margin-top:0px"><span id='spanAcaoForm'><i class='glyphicon glyphicon-chevron-right'></i>Cadastro</span> Cotacao.status <?php // echo $button ?></h2>   
        ...
        <table class='table'><tr>  <td>   
                    ...
                    <label for="character varying">Status Nm* <?php echo form_error('status_nm') ?></label>
                                        </div>
                        </td>  <td>  
                            <div class="item form-group">  <input type="text" class="form-control" name="status_nm" id="status_nm"  placeholder="Status Nm"  v-model="form.status_nm" required='required'   maxlength = '200' />	</div> 
                 </td>  </tr><tr> 
                <td colspan='2'>        
...
<a href="<?php echo site_url('status') ?>" class="btn btn-default">Voltar</a> </td>
</tr>  
...
<script>
        new Vue({
            ...
            data: {
                message: '',
                button: "<?= $button ?>",
                controller: "<?= $controller ?>",    form: { status_nm: "<?= $status_nm?>",
