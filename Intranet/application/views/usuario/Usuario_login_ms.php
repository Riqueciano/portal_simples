...
<body>
    <div id="app" class="login-box">
        ...
        <form id="form" method="post" :action="action" @submit="submeter">
            ...
            <button class="btn"
                ...
                <span style="color: #000; font-weight: 400; font-size: 14px;">Entrar com E-mail</span>
            </button>
    ...
    <script type="module">
        ...
        const msalConfig = {
            auth: {
                clientId: "a8d471ce-626b-4ae2-9005-51b58a70a860",
                authority: "https://login.microsoftonline.com/4cd835f4-5440-408f-93a3-975fc17c384a",
                redirectUri: "https://" + "<?php echo $_SERVER['HTTP_HOST']; ?>" + "/_portal/Intranet/usuario/ms_login"
