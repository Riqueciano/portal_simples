...
class Funcao_model extends CI_Model
{
    ...
    public $table = 'dados_unico.funcao';
    public $id = 'funcao_id';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        ...
        @$this->db->ilike('dados_unico.funcao.funcao_id', $q);
	$this->db->or_ilike('funcao.funcao_ds', $q);
	$this->db->or_ilike('funcao.funcao_st', $q);
	$this->db->or_ilike('funcao.funcao_dt_criacao', $q);
	$this->db->or_ilike('funcao.funcao_dt_alteracao', $q);
    ...
    function get_limit_data($limit, $start = 0, $q = NULL) {
        $this->db->select('*');
        $this->db->order_by($this->table.'.'.$this->id, $this->order);
        @$this->db->ilike('funcao.funcao_id', $q);
	$this->db->or_ilike('funcao.funcao_ds', $q);
	$this->db->or_ilike('funcao.funcao_st', $q);
	$this->db->or_ilike('funcao.funcao_dt_criacao', $q);
	$this->db->or_ilike('funcao.funcao_dt_alteracao', $q);
...
/* Final do arquivo Funcao_model.php */
/* Local: ./application/models/Funcao_model.php */
/* Data - 2022-06-29 19:57:28 */