...
<html>
    <head>
        <title>v3code Codeigniter 3.0</title>
    ...
    <body>
        <div class="row">
            <div class="col-md-5">
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <label><input type='checkbox'checked name='flag_service'  value='1'/>Service (negocio)</label>
                    </div>
            ...
            <div class="col-md-7">
                <h3 style="margin-top: 0px">Codeigniter <b style='color:green'>VUE.JS 3</b> - CRUD Generator @Riqueciano</h3>
                ...
                <ul>
                    ...
                    <li>-N�o suporta time with time zone, apenas date</li>
