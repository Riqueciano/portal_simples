<?php
    ...
    //INICIA A TABELA
    echo '<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">';
    ...
    while ($linha = pg_fetch_assoc($rsConsulta))
    {
        ...
        //VERIFICA SE É A ULTIMA COLUNA
        if ($Colunas == 3)
        {
            //CRIA A LINHA
            echo '</tr>';

            //RETORNA A COLUNA PARA O INICIO
            $Colunas = 0;
        }
    }
    ...
    if(isset($_SESSION["Sistemas"])){unset($_SESSION["Sistemas"]);}
