...
{  
    echo "<a href='".$PaginaLocal."Consultar.php?cod=".$CodigoRegistro."&acao=consultar&acaoTitulo=Consultar'><img src='https://www.portalsema.ba.gov.br/_portal/Icones/ico_consultar.png' title='Consultar' alt='Consultar' border='0'></a>";
}
echo "</td>";
...
echo "<td width='20' align='center'><a href='".$PaginaLocal."Excluir.php?cod=".$CodigoRegistro."&acao=consultar&acaoTitulo=Excluir'><img src='https://www.portalsema.ba.gov.br/_portal/Icones/ico_excluir.png' title='Excluir' alt='Excluir' border='0'></a></td>";
$click = "onclick=\"window.open('RelatorioCertidaoTempoServicoPDF.php?funcionarioId='+'$funcionarioId'+'&dtEmissao='+'$dtEmissao'+'&certidaoId='+'$numCodigo' , 'Relatorio')";
echo "<td style='cursor: pointer'><img src='https://www.portalsema.ba.gov.br/_portal/Icones/ico_imprimir.png' $click ></td>";
