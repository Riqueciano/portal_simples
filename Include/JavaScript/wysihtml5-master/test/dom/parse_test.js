if (wysihtml5.browser.supported()) {
  ...
  test("Advanced tests using tags and attributes", function() {
    ...
    this.equal(
      this.sanitize(
        ...
        '<div><video src="pr0n.avi">foobar</video><img src="https://foo.gif" height="10" width="10"><img src="/foo.gif"></div>' +
        '<div><a href="https://www.google.de"></a></div>',
        rules
      ),
      '<h2>take this you snorty little sanitizer</h2>' +
      '<h2>yes, you!</h2>' +
      '<span><img alt="foo" border="1" src="https://foo.gif" height="10" width="10"><img alt="foo" border="1"></span>' +
      '<span><i title=""></i></span>'
    );
  });
  ...
  test("Check Firefox misbehavior with tilde characters in urls", function() {
    ...
    // which is wrong
    ok(
      this.sanitize('<a href="https://google.com/~foo"></a>', rules).indexOf("~") !== -1
    );
  });
