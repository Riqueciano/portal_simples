...
function stateAddRoteiroPassagem()
{
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
		...
		if(document.getElementById("txtRoteiroIntermediario").value == 1){
			$('#mostraObsLblIntermediario').show();
			$('#mostraObsTxtIntermediario').show();
		}else{
			$('#mostraObsLblIntermediario').hide();
			$('#mostraObsTxtIntermediario').hide();
		}
