            ...
            <table cellpadding="0" border="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="top" class="LinhaTexto">
                        <table cellpadding="0" border="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="275" class="dataField">
                                    &nbsp;<input name="txtFiltro" id="txtFiltro" maxlength="100" type="text" value="<?=$RetornoFiltro?>" style=" width:265px; height: 15px;"/>
                                </td>
                                ...
                                <?php
                                    ...
                                    echo "  <option value='T' " .$strTodas. ">Todas</option>";
                                    echo "  <option value='0' " .$strAbertas. ">Abertas</option>";
                                    echo "  <option value='1' " .$strFechadas. ">Fechadas</option>";
                                    echo "</select>";
                                ?>
                                </td>
                            </tr>
